<?php
/**
 * Register a custom post type called "infos-deux".
 *
 * @see get_post_type_labels() for label keys.
 */
function wpdocs_codex_infos2_init() {
    $labels = array(
        'name'                  => _x( 'infos', 'Post type general name', 'blank_1' ),
        'singular_name'         => _x( 'infos', 'Post type singular name', 'blank_1' ),
        'menu_name'             => _x( 'infos part 2', 'Admin Menu text', 'blank_1' ),
    ...
    register_post_type( 'infos2', $args );
}
 
add_action( 'init', 'wpdocs_codex_infos2_init' );