<?php
/**
 * Register a custom post type called "web".
 *
 * @see get_post_type_labels() for label keys.
 */
function wpdocs_codex_webs_init() {
    $labels = array(
        'name'                  => _x( 'webs', 'Post type general name', 'blank_1' ),
        'singular_name'         => _x( 'web', 'Post type singular name', 'blank_1' ),
        'menu_name'             => _x( 'web', 'Admin Menu text', 'blank_1' ),
        'name_admin_bar'        => _x( 'web', 'Add New on Toolbar', 'blank_1' ),
        'add_new'               => __( 'Ajouter un nouveau', 'blank_1' ),
        'add_new_item'          => __( 'Ajouter un nouveau web', 'blank_1' ),
        'new_item'              => __( 'Nouveau web', 'blank_1' ),
        'edit_item'             => __( 'Modifier un web', 'blank_1' ),
        'view_item'             => __( 'Voir le web', 'blank_1' ),
        'all_items'             => __( 'Tous les webs', 'blank_1' ),
        'search_items'          => __( 'Rechercher des webs', 'blank_1' ),
        'parent_item_colon'     => __( 'Parent du web:', 'blank_1' ),
        'not_found'             => __( 'Aucun web trouvé.', 'blank_1' ),
        'not_found_in_trash'    => __( 'Aucun web trouvée dans la corbeille.', 'blank_1' ),
        'featured_image'        => _x( 'Image de couverture du web', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'blank_1' ),
    ...
    register_post_type( 'webs', $args );
}
 
add_action( 'init', 'wpdocs_codex_webs_init' );