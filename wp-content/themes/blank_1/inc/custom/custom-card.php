<?php
/**
 * Register a custom post type called "card".
 *
 * @see get_post_type_labels() for label keys.
 */
function wpdocs_codex_cards_init() {
    $labels = array(
        'name'                  => _x( 'cards', 'Post type general name', 'blank_1' ),
        'singular_name'         => _x( 'card', 'Post type singular name', 'blank_1' ),
        'menu_name'             => _x( 'card', 'Admin Menu text', 'blank_1' ),
        'name_admin_bar'        => _x( 'card', 'Add New on Toolbar', 'blank_1' ),
        'add_new'               => __( 'Ajouter un nouveau', 'blank_1' ),
        'add_new_item'          => __( 'Ajouter un nouveau card', 'blank_1' ),
        'new_item'              => __( 'Nouveau card', 'blank_1' ),
        'edit_item'             => __( 'Modifier un card', 'blank_1' ),
        'view_item'             => __( 'Voir le card', 'blank_1' ),
        'all_items'             => __( 'Tous les cards', 'blank_1' ),
        'search_items'          => __( 'Rechercher des cards', 'blank_1' ),
        'parent_item_colon'     => __( 'Parent du card:', 'blank_1' ),
        'not_found'             => __( 'Aucun card trouvé.', 'blank_1' ),
        'not_found_in_trash'    => __( 'Aucun card trouvée dans la corbeille.', 'blank_1' ),
        'featured_image'        => _x( 'Image de couverture du card', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'blank_1' ),
...
add_action( 'init', 'wpdocs_codex_cards_init' );